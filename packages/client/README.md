...
Framework-agnostic client library for Bloom Auth.
...
```typescript
import { bloomClient, autumnClient } from '@bloom/client'
...
```typescript
import type { ClientPlugin } from '@bloom/client'
...
```typescript
import type { User, Session, BloomResponse } from '@bloom/client'
